...
{#snippet info()}
	<div class="card">
		<div class="card-header"><TraitIcon trait={trait.trait} /> {trait.trait.name} {trait.active}/{trait.levels[trait.level].amount}</div>
		<div class="card-body">
...
<TraitIcon trait={trait.trait} /> {trait.trait.name} {trait.active}/{trait.levels[trait.level].amount}
